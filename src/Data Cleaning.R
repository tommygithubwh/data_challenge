...
## Reading in the data 
Ep_Drugs_ICB <- read.csv('Epilepsy_Drugs_By_ICB.csv')
Ep_Prev_CCG <- read.csv('Epilepsy_By_CCG.csv')
Ep_Prev_ICB <- read.csv('Epilepsy_Prevalence_ICB_2007.csv')
Ep_Drugs_PCN <- read.csv('Epilepsy_Drugs_By_PCN.csv')
CCG_ICB_Codes <- read.xlsx('CCG_IBS_Region.xlsx')
PCN_CCG_Codes <- read.xlsx('B1357-PCN-Adjusted-Populations-V1.3-updated-31-March.xlsx', sheet = 'PCNs')
PCN_CCG_Codes2 <- read.xlsx('Sheet 1_data.xlsx')
